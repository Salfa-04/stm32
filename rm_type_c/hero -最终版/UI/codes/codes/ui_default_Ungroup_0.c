...
ui_interface_string_t* ui_default_Ungroup_shoot = &ui_default_Ungroup_0.option;
...
void _ui_init_default_Ungroup_0() {
    ...
    ui_default_Ungroup_0.option.start_x = 59;
    ui_default_Ungroup_0.option.start_y = 738;
    ui_default_Ungroup_0.option.color = 6;
    ui_default_Ungroup_0.option.str_length = 8;
    ui_default_Ungroup_0.option.width = 5;
    strcpy(ui_default_Ungroup_shoot->string, "shoot：NO");
