...
//底盘电机速度环PID
#define M3505_MOTOR_SPEED_PID_KP 30000.0f//15000.0f
#define M3505_MOTOR_SPEED_PID_KI 20.0f//10.0f
#define M3505_MOTOR_SPEED_PID_KD 0.5f//0.0f
#define M3505_MOTOR_SPEED_PID_MAX_OUT MAX_MOTOR_CAN_CURRENT
#define M3505_MOTOR_SPEED_PID_MAX_IOUT 2000.0f

//chassis follow angle PID
//底盘旋转跟随PID
#define CHASSIS_FOLLOW_GIMBAL_PID_KP 40.0f//80.0f//50.f//50.0f//40.0f
#define CHASSIS_FOLLOW_GIMBAL_PID_KI 0.1f//1.0f//0.5f//1.0f//0.10f
#define CHASSIS_FOLLOW_GIMBAL_PID_KD 0.0f
#define CHASSIS_FOLLOW_GIMBAL_PID_MAX_OUT 10.0f//6.0f
#define CHASSIS_FOLLOW_GIMBAL_PID_MAX_IOUT 1.0f//0.2f
...
typedef struct
{
  ...
  const RC_ctrl_t *chassis_RC_last;          //用于键鼠和遥控器的控制主权切换
  control_mode control_mode_flag;
