...
#define TB6612_MOTORA_PWM_SET(x) TIM12->CCR1 = (x)
#define TB6612_MOTORB_PWM_SET(x) TIM12->CCR2 = (x)
#define TB6612_MOTORC_PWM_SET(x) TIM9->CCR2 = (x)
#define TB6612_MOTORD_PWM_SET(x) TIM9->CCR1 = (x)
