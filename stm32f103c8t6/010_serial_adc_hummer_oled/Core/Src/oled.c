...
{
  HAL_I2C_Mem_Write(&I2C_CHANNEL, 0x78, 0x00, I2C_MEMADD_SIZE_8BIT, &cmd, 1, 0x100);
}

// 向设备写数据
void OLED_WR_DATA(uint8_t data)
{
  HAL_I2C_Mem_Write(&I2C_CHANNEL, 0x78, 0x40, I2C_MEMADD_SIZE_8BIT, &data, 1, 0x100);
}
...
// no: 字符序号，即用取模软件得出的数组`Hzk[][16]`的每个字的索引
//
// 取模时注意要设置 列行式 逆向
//
// ```
